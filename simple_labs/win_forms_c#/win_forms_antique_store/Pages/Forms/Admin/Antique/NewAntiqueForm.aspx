<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/Main.Master" AutoEventWireup="true" CodeBehind="NewAntiqueForm.aspx.cs" Inherits="Антикварный_магазин.Pages.Login.Seller.Antique.NewElemForm" %>

<asp:Content ID="NewAntiqueContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div class="content">
        ...
        <asp:Button runat="server" ID="AddAntiqueButton" OnClick="AddAntiqueButton_Click" Text="Добавить" CssClass="button" />

...
{
    public partial class NewCategoryForm : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string category = Session["New_category_antique_category"].ToString();
            switch (category)
            {
        ...
        protected void saveJewelry(object sender, EventArgs e)
        {
            using (var context = new AntiqueStore())
            {
                ...
                try
                {
                    int antiqueId = int.Parse(Session["New_category_antique_ID"].ToString());

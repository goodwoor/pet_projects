<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/Main.Master" AutoEventWireup="true" CodeBehind="RedactCategoryForm.aspx.cs" Inherits="Антикварный_магазин.Pages.Forms.Admin.Antique.RedactCategoryForm" %>

<asp:Content ID="RedactCategoryContent" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="center-display">
        ...
        <asp:Panel runat="server" ID="IzdelPanel">
            ...
            <asp:Button runat="server" ID="AddIzdeleButton" OnClick="saveJewelry" Text="Сохранить" CssClass="button" />
        </asp:Panel>
        ...
        <asp:Panel runat="server" ID="WeaponPanel">
            ...
            <asp:Button runat="server" ID="AddWeaponButton" OnClick="saveWeapon" Text="Сохранить" CssClass="button" />
        </asp:Panel>
        ...
        <asp:Panel runat="server" ID="ProizvedPanel">
            ...
            <asp:Button runat="server" ID="AddProizvedButton" OnClick="saveProizved" Text="Сохранить" CssClass="button" />
        </asp:Panel>
        ...
        <asp:Panel runat="server" ID="BookPanel">
            ...
            <asp:Button runat="server" ID="AddBookButton" OnClick="saveBook" Text="Сохранить" CssClass="button" />
        </asp:Panel>
        ...
        <asp:Panel runat="server" ID="ClockPanel">
            ...
            <asp:Button runat="server" ID="AddClockButton" OnClick="saveClock" Text="Сохранить" CssClass="button" />
        </asp:Panel>
